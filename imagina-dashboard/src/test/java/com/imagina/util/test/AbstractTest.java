...
public abstract class AbstractTest {
	...
	public void setUp() throws Exception {
		...
		try {
			applicationContext = new ClassPathXmlApplicationContext(new String[] {"/beans/application/context/imagina-dashboard.xml",
					"/beans/application/context/imagina-dashboard-log4j.xml",});
		} catch (Exception e) {
			logger.error(ExceptionUtils.getStackTrace(e));
		}
	}
