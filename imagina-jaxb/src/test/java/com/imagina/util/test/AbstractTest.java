...
public abstract class AbstractTest {
	...
	public void setUp() throws Exception {
		...
		try {
			applicationContext = new ClassPathXmlApplicationContext(new String[] {"/beans/application/context/imagina-jaxb.xml",
					"/beans/application/context/imagina-jaxb-log4j.xml",});
		} catch (Exception e) {
			logger.error(ExceptionUtils.getStackTrace(e));
		}
	}
